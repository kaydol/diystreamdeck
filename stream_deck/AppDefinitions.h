...
#define DEF_ERR_ACCESS_TO_NOT_INITIALIZED_BMP 2
...
#define DEF_ERR_NO_ENTRIES_IN_CONFIG 8
#define DEF_ERR_TOO_MANY_ENTRIES 9
#define DEF_ERR_NO_SD_CARD 10
...
#define DEF_BUTTON_RECTANGLE_SPACING 10 
#define DEF_SCREEN_PADDING 6
